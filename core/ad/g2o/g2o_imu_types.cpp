...
void EdgeInertial::computeError() {
  ...
  /// Preintegration error term (4.41)
  const Vec3d er =
...
void EdgeInertial::linearizeOplus() {
  ...
  /// Jacobian matrix
  /// Note that there are 3 indices: vertex index, residual index, and variable
  /// index inside the vertex Variable order: pose1(R1,p1), v1, bg1, ba1,
  /// pose2(R2,p2), v2 Residual order: eR, ev, ep; residuals are arranged by
  /// rows and variables by columns
