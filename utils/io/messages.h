...
#define MSG_ASSERT(condition, message)                                         \
  {                                                                            \
    if (!(condition)) {                                                        \
      ...
      std::cerr << red << "Assertion failed at " << __FILE__ << ":"            \
                << __LINE__;                                                   \
...
#define MSG_INFO(message) {MSG_LOG(message, "INFO: ", IoColor::Blue())}
...
#define MSG_WARN(message) {MSG_LOG(message, "WARNING: ", IoColor::Yellow())}
