...
parser.add_option("--initial_poses", dest="initial_poses",
                  default="./poses_original.txt", help="The filename that contains the original poses.")
parser.add_option("--optimized_poses", dest="optimized_poses",
                  default="./poses_optimized.txt", help="The filename that contains the optimized poses.")
...
if poses_original is not None:
  ...
  if options.axes_equal:
    try:
        ...
        print('Error: cannot set axes.set_aspect(\'equal\')')      
        pass    
    set_axes_equal(axes)
