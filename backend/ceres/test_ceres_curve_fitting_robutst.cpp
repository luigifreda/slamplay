...
int main(int argc, char** argv) {
  ...
  // W.r.t. slamplay/ceres/test_ceres_curve_fitting.cpp, we use a Cauchy Loss function. 
  // CauchyLoss is one of the loss functions that ships with Ceres Solver. The argument 0.5
  // specifies the scale of the loss function. 
  // As for scale see the code documentation in loss_function.h: 
  /*
    // Scaling
    // -------
