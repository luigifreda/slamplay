...
/// Structure of Pose and Internal Parameters
...
/// The vertex of the pose plus camera internal parameters, 9-dimensional, the first three-dimensional is so3, and the next is t, f, k1, k2
