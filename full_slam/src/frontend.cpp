...
int Frontend::TrackLastFrame() {
    ...
    cv::calcOpticalFlowPyrLK(
        ...
        kps_current, status, error, cv::Size(tracking_lk_patch_size, tracking_lk_patch_size), tracking_lk_max_level,
...
int Frontend::FindFeaturesInRight() {
    ...
    cv::calcOpticalFlowPyrLK(
        ...
        kps_right, status, error, cv::Size(tracking_lk_patch_size, tracking_lk_patch_size), tracking_lk_max_level,
        cv::TermCriteria(cv::TermCriteria::COUNT + cv::TermCriteria::EPS, 30, 0.01),
        cv::OPTFLOW_USE_INITIAL_FLOW);
