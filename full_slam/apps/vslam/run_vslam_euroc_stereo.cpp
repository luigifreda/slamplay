...
#include "macros.h"
#include "vslam/visual_odometry.h"
...
DEFINE_string(config_file, configDir + "/vslam/euroc.yaml", "config file path");

int main(int argc, char **argv) {
  google::ParseCommandLineFlags(&argc, &argv, true);

  vslam::VisualOdometry::Ptr vo(
      new vslam::VisualOdometry(FLAGS_config_file, vslam::DatasetType::EUROC));
