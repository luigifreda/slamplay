...
/**
 * Backend
 * There is a separate optimization thread, and the optimization is started when
 * the Map is updated Map update is triggered by the front end
 */
class Backend {
public:
  ...
  // Set the left and right destination cameras to obtain internal and external
  // parameters
