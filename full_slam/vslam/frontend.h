...
/**
 * Front end
 * Estimate the current frame Pose, add keyframes to the map and trigger
 * optimization when the keyframe conditions are met
 */
class Frontend {
public:
...
public:
  ...
  std::string GetStatusString() const {
    return frontendStatusStrings[static_cast<int>(status_)];
  }
