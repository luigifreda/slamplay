...
public:
  ...
  IMUData(const double &gx, const double &gy, const double &gz,
          const double &ax, const double &ay, const double &az, const double &t)
      : mfGyro(gx, gy, gz), mfAcce(ax, ay, az), mfTimeStamp(t) {}

  IMUData(const Eigen::Vector3d gyro, const Eigen::Vector3d &acce,
          const double &time)
  ...
  static Eigen::Matrix3d
      mfGyrMeasCov; // The covariance matrix of the gyroscope is a diagonal
                    // matrix composed of variances
  static Eigen::Matrix3d
      mfAccMeasCov; // The covariance matrix of the accelerometer is a diagonal
                    // matrix composed of variances
  ...
  static Eigen::Matrix3d
      mfAccBiasRWCov; // covariance matrix of accelerometer random walk
};
