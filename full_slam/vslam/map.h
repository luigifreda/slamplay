...
/**
 * @brief map
 * Interaction with the map: the front end calls InsertKeyframe and
 * InsertMapPoint to insert new frames and map points, the back end maintains
 * the structure of the map, determines outlier/elimination, etc.
 */
class Map {
public:
