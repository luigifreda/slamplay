...
nvinfer1::IBuilder* createBuilder()
{
    ...
    return nvinfer1::createInferBuilder(tensorrt_buffers::gLogger.getTRTLogger());
#else
    return {};
#endif
}
...
nvinfer1::IRuntime* createRuntime()
{
    ...
    return nvinfer1::createInferRuntime(tensorrt_buffers::gLogger.getTRTLogger());
#else
    return {};
#endif
}
...
nvinfer1::IRefitter* createRefitter(nvinfer1::ICudaEngine& engine)
{
    ...
    return nvinfer1::createInferRefitter(engine, tensorrt_buffers::gLogger.getTRTLogger());
#else
    return {};
#endif
}
...
nvonnxparser::IParser* createONNXParser(nvinfer1::INetworkDefinition& network)
{
    ...
    return nvonnxparser::createParser(network, tensorrt_buffers::gLogger.getTRTLogger());
#else
    return {};
#endif
}
